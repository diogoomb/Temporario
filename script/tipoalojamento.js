...
function estiloTotalAlojamentos91Concelhos(feature, latlng) {
    if(!feature.properties.TipoTot91){
        feature.properties.TipoTot91 = "sem dados"
    }
...
var minAlojFamiNaoClass01 = 0;
var maxAlojFamiNaoClass01 = 0;;
function estiloalojaFamNaoClass01(feature, latlng) {
    if(feature.properties.AlNClass01< minAlojFamiNaoClass01 || minAlojFamiNaoClass01 ===0){
    ...
    return L.circleMarker(latlng, {
        ...
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.AlNClass01,2)
    });
}
...
function estiloalojaFamNaoClass91(feature, latlng) {
    ...
    return L.circleMarker(latlng, {
        ...
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.AlNClass91,2)
    });
}
...
function estilototalAlojaFreguesia21(feature, latlng) {
    if(feature.properties.F_T_Aloj21< minTotalAloja21Freg || minTotalAloja21Freg ===0){
...
function estilototalAlojaFreguesia11(feature, latlng) {
    if(feature.properties.F_T_Aloj11< minTotalAloja11Freg || minTotalAloja11Freg ===0){
...
var minTotalAloja01Freg = 0;
var maxTotalAloja01Freg = 0;
function estilototalAlojaFreguesia01(feature, latlng) {
    if(!feature.properties.F_T_Aloj01){
        feature.properties.F_T_Aloj01 = "sem dados"
    }
    if(feature.properties.F_T_Aloj01< minTotalAloja01Freg || minTotalAloja01Freg ===0){
...
var minTotalAloja91Freg = 0;
var maxTotalAloja91Freg = 0;
function estilototalAlojaFreguesia91(feature, latlng) {
    if(feature.properties.F_T_Aloj91< minTotalAloja91Freg || minTotalAloja91Freg ===0){
...
function estiloAlojaFami21Freg(feature, latlng) {
    if(feature.properties.F_AloFam21< minAlojaFami21Freg || minAlojaFami21Freg ===0){
...
function estiloAlojaFami11Freg(feature, latlng) {
    if(feature.properties.F_AloFam11< minAlojaFami11Freg || minAlojaFami11Freg ===0){
...
var minAlojaFami01Freg = 0;
var maxAlojaFami01Freg = 0;

function estiloAlojaFami01Freg(feature, latlng) {
    if(feature.properties.F_AloFam01< minAlojaFami01Freg || minAlojaFami01Freg ===0){
...
function estiloAlojaFamiNaoClass21Freg(feature, latlng) {
    if(feature.properties.F_AloNcl21< minAlojaFamiNaoClass21Freg || minAlojaFamiNaoClass21Freg ===0){
...
function estiloAlojaFamiNaoClass11Freg(feature, latlng) {
    if(feature.properties.F_AloNcl11< minAlojaFamiNaoClass11Freg || minAlojaFamiNaoClass11Freg ===0){
...
var minAlojaFamiNaoClass01Freg = 0;
var maxAlojaFamiNaoClass01Freg = 0;
function estiloAlojaFamiNaoClass01Freg(feature, latlng) {
    if(feature.properties.F_AloNcl01< minAlojaFamiNaoClass01Freg || minAlojaFamiNaoClass01Freg ===0){
...
var minAlojaFamiNaoClass91Freg = 0;
var maxAlojaFamiNaoClass91Freg = 0;
function estiloAlojaFamiNaoClass91Freg(feature, latlng) {
    if(feature.properties.F_AloNcl91< minAlojaFamiNaoClass91Freg || minAlojaFamiNaoClass91Freg ===0){
...
function estiloAlojColetivo21Freg(feature, latlng) {
    if(feature.properties.F_AloCol21< minAlojColetivo21Freg || minAlojColetivo21Freg ===0){
...
function estiloAlojColetivo11Freg(feature, latlng) {
    if(feature.properties.F_AloCol11< minAlojColetivo11Freg || minAlojColetivo11Freg ===0){
...
var minAlojColetivo01Freg = 0;
var maxAlojColetivo01Freg = 0;
function estiloAlojColetivo01Freg(feature, latlng) {
    if(feature.properties.F_AloCol01< minAlojColetivo01Freg || minAlojColetivo01Freg ===0){
...
var minAlojColetivo91Freg = 0;
var maxAlojColetivo91Freg = 0;
function estiloAlojColetivo91Freg(feature, latlng) {
    if(feature.properties.F_AloCol91< minAlojColetivo91Freg || minAlojColetivo91Freg ===0){
...
function EstiloAlojVarConcelho21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotConc(feature.properties.VarTot21)};
    }
...
function EstiloAlojFamiVarConcelho21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamConc(feature.properties.VarAF21)};
    }
...
function CorVariacaoFamClassConc(d) {
...
function EstiloAlojFamiClassVarConcelho21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamClassConc(feature.properties.VarAFC21)};
    }
...
function CorVariacaoFamNaoClassConc(d) {
...
function EstiloAlojFamiNaoClassVarConcelho21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassConc(feature.properties.VarANC21)};
    }
...
function CorVariacaoColetivosConc(d) {
...
function EstiloAlojColetivosVarConcelho21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVariacaoColetivosConc(feature.properties.VarAC21)};
    }
...
function EstiloAlojVarConcelho11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotConc(feature.properties.VarTot11)};
    }
...
function EstiloAlojVarConcelho01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotConc(feature.properties.VarTot01)};
    }
...
function EstiloAlojFamiVarConcelho11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamConc(feature.properties.VarAF11)};
    }
...
function EstiloAlojFamiVarConcelho01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamConc(feature.properties.VarAF01)};
    }
...
function EstiloAlojFamiClassVarConcelho11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamClassConc(feature.properties.VarAFC11)};
    }
...
function EstiloAlojFamiClassVarConcelho01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamClassConc(feature.properties.VarAFC01)};
    }
...
function EstiloAlojFamiNaoClassVarConcelho11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassConc(feature.properties.VarANC11)};
    }
...
function EstiloAlojFamiNaoClassVarConcelho01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassConc(feature.properties.VarANC01)};
    }
...
function EstiloAlojColetivosVarConcelho11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoColetivosConc(feature.properties.VarAC11)};
    }
...
function EstiloAlojColetivosVarConcelho01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVariacaoColetivosConc(feature.properties.VarAC01)};
    }
...
function EstiloVarTotalAlojFreg21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarTot21)};
    }
...
function EstiloVarTotalAlojFreg11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarTot11)};
    }
...
function EstiloVarTotalAlojFreg01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarTot01)};
    }
...
function EstiloVarTotalAlojFamiFreg21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarAF21)};
    }
...
function EstiloVarTotalAlojFamiFreg11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarAF11)};
    }
...
function EstiloVarTotalAlojFamiFreg01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarAF01)};
    }
...
function EstiloVarTotalAlojFamiClassFreg21_11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarAFC21)};
    }
...
function EstiloVarTotalAlojFamiClassFreg11_01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarAFC11)};
    }
...
function EstiloVarTotalAlojFamiClassFreg01_91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoTotalFreg(feature.properties.VarAFC01)};
    }
...
function CorVariacaoFamNaoClassFreg(d) {
...
var minVarTotAlojFamNaoClassFreg21_11 = 0;
var maxVarTotAlojFamNaoClassFreg21_11 = 0;

function EstiloVarTotAlojFamNaoClassFreg21_11(feature) {
    if(feature.properties.VarANC21 <= minVarTotAlojFamNaoClassFreg21_11 || minVarTotAlojFamNaoClassFreg21_11 ===0){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassFreg(feature.properties.VarANC21),
    }
...
var minVarTotAlojFamNaoClassFreg11_01 = 0;
var maxVarTotAlojFamNaoClassFreg11_01 = 0;

function EstiloVarTotAlojFamNaoClassFreg11_01(feature) {
    if(feature.properties.VarANC11 <= minVarTotAlojFamNaoClassFreg11_01 || minVarTotAlojFamNaoClassFreg11_01 ===0){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVariacaoFamNaoClassFreg(feature.properties.VarANC11)};
    }
...
var minVarTotAlojFamNaoClassFreg01_91 = 0;
var maxVarTotAlojFamNaoClassFreg01_91 = 0;

function EstiloVarTotAlojFamNaoClassFreg01_91(feature) {
    if(feature.properties.VarANC01 <= minVarTotAlojFamNaoClassFreg01_91 || minVarTotAlojFamNaoClassFreg01_91 ===0){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassFreg(feature.properties.VarANC01)};
    }
...
var minVarAlojColetivosFreg21_11 = 0;
var maxVarAlojColetivosFreg21_11 = 0;

function EstiloVarAlojColetivosFreg21_11(feature) {
    if(feature.properties.VarAC21 <= minVarAlojColetivosFreg21_11 || minVarAlojColetivosFreg21_11 ===0){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassFreg(feature.properties.VarAC21)};
    }
...
var minVarAlojColetivosFreg11_01 = 0;
var maxVarAlojColetivosFreg11_01 = 0;

function EstiloVarAlojColetivosFreg11_01(feature) {
    if(feature.properties.VarAC11 <= minVarAlojColetivosFreg11_01 || minVarAlojColetivosFreg11_01 ===0){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassFreg(feature.properties.VarAC11)};
    }
...
var minVarAlojColetivosFreg01_91 = 0;
var maxVarAlojColetivosFreg01_91 = 0;

function EstiloVarAlojColetivosFreg01_91(feature) {

    if(feature.properties.VarAC01 <= minVarAlojColetivosFreg01_91 || minVarAlojColetivosFreg01_91 ===0){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.9,
        fillColor: CorVariacaoFamNaoClassFreg(feature.properties.VarAC01)};
    }
...
function EstiloTotAlojFamPercCon21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAF21)
    };
}
...
function EstiloTotAlojFamPercCon11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAF11)
    };
}
...
function EstiloTotAlojFamPercCon01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAF01)
    };
}
...
function EstiloTotAlojFamPercCon91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAF91)
    };
}
...
function EstiloAlojFamClassPercCon21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAFC21)
    };
}
...
function EstiloAlojFamClassPercCon11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAFC11)
    };
}
...
function EstiloAlojFamClassPercCon01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAFC01)
    };
}
...
function EstiloAlojFamClassPercCon91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAFC91)
    };
}
...
function EstiloAlojFamNaoClasPercCon21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerANC21)
    };
}
...
function EstiloAlojFamNaoClasPercCon11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPercentagem(feature.properties.PerANC11)
    };
}
...
function EstiloAlojFamNaoClasPercCon01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerANC01)
    };
}
...
function EstiloAlojFamNaoClasPercCon91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerANC91)
    };
}
...
function EstiloAlojColePercCon21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAC21)
    };
}
...
function EstiloAlojColePercCon11(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAC11)
    };
}
...
function EstiloAlojColePercCon01(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAC01)
    };
}
...
function EstiloAlojColePercCon91(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 1,
        fillColor: CorPercentagem(feature.properties.PerAC91)
    };
}
...
function EstiloPercAlojColet91Freg(feature) {
    if( feature.properties.PerAC91 <= minPercAlojColet91Freg  || minPercAlojColet91Freg === 0){
...
let novaLayer = function(layer){
    ...
    if (layer == totalAlojamentos01Concelhos && naoDuplicar != 52){
        legenda('Nº de Alojamentos em 2001',maxTotalAlojamentos01Concelhos,Math.round((maxTotalAlojamentos01Concelhos-minTotalAlojamentos01Concelhos)/2),minTotalAlojamentos01Concelhos,0.1);
        contorno.addTo(map)
        slidetotalAlojamentos01Concelhos();
        naoDuplicar = 52;
    }
    if (layer == totalAlojamentos91Concelhos && naoDuplicar != 53){
        legenda('Nº de Alojamentos em 1991',maxTotalAlojamentos91Concelhos,Math.round((maxTotalAlojamentos91Concelhos-minTotalAlojamentos91Concelhos)/2),minTotalAlojamentos91Concelhos,0.1);
    ...
    if (layer == AlojamentosFamiliares01 && naoDuplicar != 54){
        legenda('Nº de Alojamentos Familiares em 2001',maxAlojaFam01,Math.round((maxAlojaFam01-minAlojaFam01)/2),minAlojaFam01,0.1);
        contorno.addTo(map);
        slideAlojamentosFamiliares01();
        naoDuplicar = 54;
    }
    if (layer == AlojamentosFamiliares91 && naoDuplicar != 55){
        legenda('Nº de Alojamentos Familiares em 1991',maxAlojaFam91,Math.round((maxAlojaFam91-minAlojaFam91)/2),minAlojaFam91,0.1);
        contornoConcelhos1991.addTo(map);
    ...
    if (layer == alojaFamClass2001 && naoDuplicar != 56){
        legenda('Nº de Alojamentos Familiares Clássicos em 2001', maxAlojFamiClass01, Math.round((maxAlojFamiClass01-minAlojFamiClass01)/2),minAlojFamiClass01,0.1);
        contorno.addTo(map);
        slidealojaFamClass2001();
        naoDuplicar = 56;
    }
    if (layer == alojaFamClass91 && naoDuplicar != 57){
        legenda('Nº de Alojamentos Familiares Clássicos em 1991', maxAlojFamiClass91, Math.round((maxAlojFamiClass91-minAlojFamiClass91)/2),minAlojFamiClass91,0.1);
        contornoConcelhos1991.addTo(map);
    ...
    if (layer == alojaFamNaoClass01 && naoDuplicar != 58){
        legenda('Nº de Alojamentos Familiares Não Clássicos em 2001', maxAlojFamiNaoClass01, Math.round((maxAlojFamiNaoClass01-minAlojFamiNaoClass01)/2),minAlojFamiNaoClass01,2);
        contorno.addTo(map);
        slidealojaFamNaoClass01();
        naoDuplicar = 58;
    }
    if (layer == alojaFamNaoClass91 && naoDuplicar != 59){
        legenda('Nº de Alojamentos Familiares Não Clássicos em 1991', maxAlojFamiNaoClass91, Math.round((maxAlojFamiNaoClass91-minAlojFamiNaoClass91)/2),minAlojFamiNaoClass91,2);
        contornoConcelhos1991.addTo(map);
    ...
    if (layer == AlojaFamColetivos01 && naoDuplicar != 60){
        legenda('Nº de Alojamentos Familiares Coletivos em 2001', maxAlojFamiColetivos01, Math.round((maxAlojFamiColetivos01-minAlojFamiColetivos01)/2),minAlojFamiColetivos01,2);
        contorno.addTo(map);
        slideAlojaFamColetivos01();
        naoDuplicar = 60;
    }
    if (layer == AlojaFamColetivos91 && naoDuplicar != 61){
        legenda('Nº de Alojamentos Familiares Coletivos em 1991', maxAlojFamiColetivos91, Math.round((maxAlojFamiColetivos91-minAlojFamiColetivos91)/2),minAlojFamiColetivos91,2);
        contornoConcelhos1991.addTo(map);
    ...
    if (layer == totalAlojaFreguesia01 && naoDuplicar != 76){
        legenda('Nº de Alojamentos  em 2001', maxTotalAloja01Freg, Math.round((maxTotalAloja01Freg-minTotalAloja01Freg)/2),minTotalAloja01Freg,0.1);
    ...
    if (layer == totalAlojaFreguesia91 && naoDuplicar != 77){
        legenda('Nº de Alojamentos  em 1991', maxTotalAloja91Freg, Math.round((maxTotalAloja91Freg-minTotalAloja91Freg)/2),minTotalAloja91Freg,0.1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojaFami01Freg && naoDuplicar != 78){
        legenda('Nº de Alojamentos Familiares  em 2001', maxAlojaFami01Freg, Math.round((maxAlojaFami01Freg-minAlojaFami01Freg)/2),minAlojaFami01Freg,0.1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojaFami91Freg && naoDuplicar != 79){
        legenda('Nº de Alojamentos Familiares  em 1991', maxAlojaFami91Freg, Math.round((maxAlojaFami91Freg-minAlojaFami91Freg)/2),minAlojaFami91Freg,0.1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojaFamiClass01Freg && naoDuplicar != 80){
        legenda('Nº de Alojamentos Familiares Clássicos em 2001', maxAlojaFamiClass01Freg, Math.round((maxAlojaFamiClass01Freg-minAlojaFamiClass01Freg)/2),minAlojaFamiClass01Freg,0.1);
        contornoFreg2001.addTo(map);
    ...
    if (layer == AlojaFamiClass91Freg && naoDuplicar != 81){
        legenda('Nº de Alojamentos Familiares Clássicos em 1991', maxAlojaFamiClass91Freg, Math.round((maxAlojaFamiClass91Freg-minAlojaFamiClass91Freg)/2),minAlojaFamiClass91Freg,0.1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojaFamiNaoClass21Freg && naoDuplicar != 15){
        legendaExcecao('Nº de Alojamentos Familiares Não Clássicos em 2021', maxAlojaFamiNaoClass21Freg, Math.round((maxAlojaFamiNaoClass21Freg-minAlojaFamiNaoClass21Freg)/2),minAlojaFamiNaoClass21Freg,1);
        contornoFreg.addTo(map);
        slideAlojaFamiNaoClass21Freg();
        naoDuplicar = 15;
    }
    if (layer == AlojaFamiNaoClass11Freg && naoDuplicar != 16){
        legendaExcecao('Nº de Alojamentos Familiares Não Clássicos em 2011', maxAlojaFamiNaoClass11Freg, Math.round((maxAlojaFamiNaoClass11Freg-minAlojaFamiNaoClass11Freg)/2),minAlojaFamiNaoClass11Freg,1);
        contornoFreg.addTo(map);
        slideAlojaFamiNaoClass11Freg();
        naoDuplicar = 16;
    }
    if (layer == AlojaFamiNaoClass01Freg && naoDuplicar != 82){
        legendaExcecao('Nº de Alojamentos Familiares Não Clássicos em 2001', maxAlojaFamiNaoClass01Freg, Math.round((maxAlojaFamiNaoClass01Freg-minAlojaFamiNaoClass01Freg)/2),minAlojaFamiNaoClass01Freg,1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojaFamiNaoClass91Freg && naoDuplicar != 83){
        legendaExcecao('Nº de Alojamentos Familiares Não Clássicos em 1991', maxAlojaFamiNaoClass91Freg, Math.round((maxAlojaFamiNaoClass91Freg-minAlojaFamiNaoClass91Freg)/2),minAlojaFamiNaoClass91Freg,1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojColetivo21Freg && naoDuplicar != 19){
        legendaExcecao('Nº de Alojamentos Coletivos em 2021', maxAlojColetivo21Freg, Math.round((maxAlojColetivo21Freg-minAlojColetivo21Freg)/2),minAlojColetivo21Freg,1);
        contornoFreg.addTo(map);
        slideAlojColetivo21Freg();
        naoDuplicar = 19;
    }
    if (layer == AlojColetivo11Freg && naoDuplicar != 20){
        legendaExcecao('Nº de Alojamentos Coletivos em 2011', maxAlojColetivo11Freg, Math.round((maxAlojColetivo11Freg-minAlojColetivo11Freg)/2),minAlojColetivo11Freg,1);
        contornoFreg.addTo(map);
        slideAlojColetivo11Freg();
        naoDuplicar = 20;
    }
    if (layer == AlojColetivo01Freg && naoDuplicar != 84){
        legendaExcecao('Nº de Alojamentos Coletivos em 2001', maxAlojColetivo01Freg, Math.round((maxAlojColetivo01Freg-minAlojColetivo01Freg)/2),minAlojColetivo01Freg,1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojColetivo91Freg && naoDuplicar != 85){
        legendaExcecao('Nº de Alojamentos Coletivos em 1991', maxAlojColetivo91Freg, Math.round((maxAlojColetivo91Freg-0)/2),1,1);
        contornoFreg2001.addTo(map);
        baseAtiva = contornoFreg2001;
    ...
    if (layer == AlojVarConcelho21_11 && naoDuplicar != 21){
        LegendaVariacoes('Variação do Total de Alojamentos entre 2021 e 2011', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojVarConcelho21_11();
        naoDuplicar = 21;
    }
    if (layer == AlojFamiVarConcelho21_11 && naoDuplicar != 22){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares entre 2021 e 2011', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiVarConcelho21_11();
        naoDuplicar = 22;
    }
    if (layer == AlojFamiClassVarConcelho21_11 && naoDuplicar != 23){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Clássicos entre 2021 e 2011', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiClassVarConcelho21_11();
        naoDuplicar = 23;
    }
    if (layer == AlojFamiNaoClassVarConcelho21_11 && naoDuplicar != 24){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Não Clássicos entre 2021 e 2011', minAlojFamiNaoClassVarConcelho11_01.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiNaoClassVarConcelho21_11();
        naoDuplicar = 24;
    }
    if (layer == AlojColetivosVarConcelho21_11 && naoDuplicar != 25){
        LegendaVariacoes('Variação do Total de Alojamentos Coletivos entre 2021 e 2011', minAlojColetivosVarConcelho21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(86,159,182,1) 10%, rgba(139,183,184,1) 20%, rgba(192,207,180,1) 30%, rgba(245,230,176,1) 40%, rgba(255,220,169,1) 50%, rgba(255,202,161,1) 60%, rgba(255,183,152,1) 70%, rgba(255,165,144,1) 80%, rgba(255,146,136,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojColetivosVarConcelho21_11();
        naoDuplicar = 25;
    }
    if (layer == AlojVarConcelho11_01 && naoDuplicar != 47){
        LegendaVariacoes('Variação do Total de Alojamentos entre 2011 e 2001', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojVarConcelho11_01();
        naoDuplicar = 47;
    }
    if (layer == AlojVarConcelho01_91 && naoDuplicar != 62){
        LegendaVariacoes('Variação do Total de Alojamentos entre 2001 e 1991', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojVarConcelho01_91();
        naoDuplicar = 62;
    }
    if (layer == AlojFamiVarConcelho11_01 && naoDuplicar != 48){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares entre 2011 e 2001', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiVarConcelho11_01();
        naoDuplicar = 48;
    }
    if (layer == AlojFamiVarConcelho01_91 && naoDuplicar != 63){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares entre 2001 e 1991', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiVarConcelho01_91();
        naoDuplicar = 63;
    }
    if (layer == AlojFamiClassVarConcelho11_01 && naoDuplicar != 49){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Clássicos entre 2011 e 2001', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiClassVarConcelho11_01();
        naoDuplicar = 49;
    }
    if (layer == AlojFamiClassVarConcelho01_91 && naoDuplicar != 64){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Clássicos entre 2001 e 1991', minAlojVarConcelho01_91.toFixed(2),maxAlojVarConcelho01_91.toFixed(2),"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(130,179,185,1) 10%, rgba(226,222,178,1) 20%, rgba(255,226,171,1) 30%, rgba(255,212,165,1) 40%, rgba(255,198,159,1) 50%, rgba(255,184,152,1) 60%, rgba(255,170,146,1) 70%, rgba(255,156,140,1) 80%, rgba(255,142,134,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiClassVarConcelho01_91();
        naoDuplicar = 64;
    }
    if (layer == AlojFamiNaoClassVarConcelho11_01 && naoDuplicar != 50){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Não Clássicos entre 2011 e 2001', minAlojFamiNaoClassVarConcelho11_01.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiNaoClassVarConcelho11_01();
        naoDuplicar = 50;
    }
    if (layer == AlojFamiNaoClassVarConcelho01_91 && naoDuplicar != 65){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Não Clássicos entre 2001 e 1991', minAlojFamiNaoClassVarConcelho11_01.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(255,228,172,1) 10%, rgba(255,217,167,1) 20%, rgba(255,206,162,1) 30%, rgba(255,195,157,1) 40%, rgba(255,184,152,1) 50%, rgba(255,172,147,1) 60%, rgba(255,161,142,1) 70%, rgba(255,150,137,1) 80%, rgba(255,139,132,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojFamiNaoClassVarConcelho01_91();
        naoDuplicar = 65;
    }
    if (layer == AlojColetivosVarConcelho11_01 && naoDuplicar != 51){
        LegendaVariacoes('Variação do Total de Alojamentos Coletivos entre 2011 e 2001', minAlojColetivosVarConcelho21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(86,159,182,1) 10%, rgba(139,183,184,1) 20%, rgba(192,207,180,1) 30%, rgba(245,230,176,1) 40%, rgba(255,220,169,1) 50%, rgba(255,202,161,1) 60%, rgba(255,183,152,1) 70%, rgba(255,165,144,1) 80%, rgba(255,146,136,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojColetivosVarConcelho11_01();
        naoDuplicar = 51;
    }
    if (layer == AlojColetivosVarConcelho01_91 && naoDuplicar != 66){
        LegendaVariacoes('Variação do Total de Alojamentos Coletivos entre 2001 e 1991', minAlojColetivosVarConcelho21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(86,159,182,1) 10%, rgba(139,183,184,1) 20%, rgba(192,207,180,1) 30%, rgba(245,230,176,1) 40%, rgba(255,220,169,1) 50%, rgba(255,202,161,1) 60%, rgba(255,183,152,1) 70%, rgba(255,165,144,1) 80%, rgba(255,146,136,1) 90%, rgba(255,127,127,1) 100%");
        slideAlojColetivosVarConcelho01_91();
        naoDuplicar = 66;
    }
    if (layer == VarTotalAlojFreg21_11 && naoDuplicar != 26){
        LegendaVariacoes('Variação do Total de Alojamentos entre 2021 e 2011', minVarTotalAlojFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFreg21_11();
        naoDuplicar = 26;
    }
    if (layer == VarTotalAlojFreg11_01 && naoDuplicar != 86){
        LegendaVariacoes('Variação do Total de Alojamentos entre 2011 e 2001', minVarTotalAlojFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFreg11_01();
        naoDuplicar = 86;
    }
    if (layer == VarTotalAlojFreg01_91 && naoDuplicar != 87){
        LegendaVariacoes('Variação do Total de Alojamentos entre 2001 e 1991', minVarTotalAlojFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFreg01_91();
        naoDuplicar = 87;
    }
    if (layer == VarTotalAlojFamiFreg21_11 && naoDuplicar != 27){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares entre 2021 e 2011', minVarTotalAlojFamiFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFamiFreg21_11();
        naoDuplicar = 27;
    }
    if (layer == VarTotalAlojFamiFreg11_01 && naoDuplicar != 88){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares entre 2011 e 2001', minVarTotalAlojFamiFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFamiFreg11_01();
        naoDuplicar = 88;
    }
    if (layer == VarTotalAlojFamiFreg01_91 && naoDuplicar != 89){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares entre 2001 e 1991', minVarTotalAlojFamiFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFamiFreg01_91();
        naoDuplicar = 89;
    }
    if (layer == VarTotalAlojFamiClassFreg21_11 && naoDuplicar != 28){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Clássicos entre 2021 e 2011', minVarTotalAlojFamiClassFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFamiClassFreg21_11();
        naoDuplicar = 28;
    }
    if (layer == VarTotalAlojFamiClassFreg11_01 && naoDuplicar != 90){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Clássicos entre 2011 e 2001', minVarTotalAlojFamiClassFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFamiClassFreg11_01();
        naoDuplicar = 90;
    }
    if (layer == VarTotalAlojFamiClassFreg01_91 && naoDuplicar != 91){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Clássicos entre 2001 e 1991', minVarTotalAlojFamiClassFreg01_91.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(96,164,187,1) 10%, rgba(159,192,182,1) 20%, rgba(222,220,178,1) 30%, rgba(255,227,172,1) 40%, rgba(255,211,164,1) 50%, rgba(255,194,157,1) 60%, rgba(255,177,150,1) 70%, rgba(255,161,142,1) 80%, rgba(255,144,135,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotalAlojFamiClassFreg01_91();
        naoDuplicar = 91;
    }
    if (layer == VarTotAlojFamNaoClassFreg21_11 && naoDuplicar != 29){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Não Clássicos entre 2021 e 2011', minVarTotAlojFamNaoClassFreg21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotAlojFamNaoClassFreg21_11();
        naoDuplicar = 29;
    }
    if (layer == VarTotAlojFamNaoClassFreg11_01 && naoDuplicar != 92){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Não Clássicos entre 2011 e 2001', minVarTotAlojFamNaoClassFreg21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotAlojFamNaoClassFreg11_01();
        naoDuplicar = 92;
    }
    if (layer == VarTotAlojFamNaoClassFreg01_91 && naoDuplicar != 93){
        LegendaVariacoes('Variação do Total de Alojamentos Familiares Não Clássicos entre 2001 e 1991', minVarTotAlojFamNaoClassFreg21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideVarTotAlojFamNaoClassFreg01_91();
        naoDuplicar = 93;
    }
    if (layer == VarAlojColetivosFreg21_11 && naoDuplicar != 30){
        LegendaVariacoes('Variação do Total de Alojamentos Coletivos entre 2021 e 2011', minVarAlojColetivosFreg21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideVarAlojColetivosFreg21_11();
        naoDuplicar = 30;
    }
    if (layer == VarAlojColetivosFreg11_01 && naoDuplicar != 94){
        LegendaVariacoes('Variação do Total de Alojamentos Coletivos entre 2011 e 2001', minVarAlojColetivosFreg21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideVarAlojColetivosFreg11_01();
        naoDuplicar = 94;
    }
    if (layer == VarAlojColetivosFreg01_91 && naoDuplicar != 75){
        LegendaVariacoes('Variação do Total de Alojamentos Coletivos entre 2001 e 1991', minVarAlojColetivosFreg21_11.toFixed(2),100,"linear-gradient(90deg, rgba(34,136,191,1) 0%, rgba(78,155,188,1) 10%, rgba(122,175,185,1) 20%, rgba(166,195,182,1) 30%, rgba(210,215,179,1) 40%, rgba(255,235,175,1) 50%, rgba(255,214,166,1) 60%, rgba(255,192,156,1) 70%, rgba(255,171,147,1) 80%, rgba(255,149,137,1) 90%, rgba(255,127,127,1) 100%");
        slideVarAlojColetivosFreg01_91();
        naoDuplicar = 75;
    }
    if (layer == TotAlojFamPercCon21 && naoDuplicar != 33){
        legendaGradiente('Percentagem de Alojamentos Familiares em 2021')
        slideTotAlojFamPercCon21();
        naoDuplicar = 33;
    }
    if (layer == TotAlojFamPercCon11 && naoDuplicar != 34){
        legendaGradiente('Percentagem de Alojamentos Familiares em 2011')
        slideTotAlojFamPercCon11();
        naoDuplicar = 34;
    }
    if (layer == TotAlojFamPercCon01 && naoDuplicar != 67){
        legendaGradiente('Percentagem de Alojamentos Familiares em 2001')
        slideTotAlojFamPercCon01();
        naoDuplicar = 67;
    }
    if (layer == TotAlojFamPercCon91 && naoDuplicar != 71){
        legendaGradiente('Percentagem de Alojamentos Familiares em 1991')
        slideTotAlojFamPercCon91();
        naoDuplicar = 71;
    }
    if (layer == AlojFamClassPercCon21 && naoDuplicar != 35){
        legendaGradiente('Percentagem de Alojamentos Familiares Clássicos em 2021');
        slideAlojFamClassPercCon21();
        naoDuplicar = 35;
    }
    if (layer == AlojFamClassPercCon11 && naoDuplicar != 36){
        legendaGradiente('Percentagem de Alojamentos Familiares Clássicos em 2011');
        slideAlojFamClassPercCon11();
        naoDuplicar = 36;
    } 
    if (layer == AlojFamClassPercCon01 && naoDuplicar != 68){
        legendaGradiente('Percentagem de Alojamentos Familiares Clássicos em 2001');
        slideAlojFamClassPercCon01();
        naoDuplicar = 68;
    } 
    if (layer == AlojFamClassPercCon91 && naoDuplicar != 72){
        legendaGradiente('Percentagem de Alojamentos Familiares Clássicos em 1991');
        slideAlojFamClassPercCon91();
        naoDuplicar = 72;
    } 
    if (layer == AlojFamNaoClasPercCon21 && naoDuplicar != 37){
        legendaGradiente('Percentagem de Alojamentos Familiares Não Clássicos em 2021');
        slideAlojFamNaoClassPercCon21();
        naoDuplicar = 37;
    }
    if (layer == AlojFamNaoClasPercCon11 && naoDuplicar != 38){
        legendaGradiente('Percentagem de Alojamentos Familiares Não Clássicos em 2011');
        slideAlojFamNaoClasPercCon11();
        naoDuplicar = 38;
    } 
    if (layer == AlojFamNaoClasPercCon01 && naoDuplicar != 69){
        legendaGradiente('Percentagem de Alojamentos Familiares Não Clássicos em 2001');
        slideAlojFamNaoClasPercCon01();
        naoDuplicar = 69;
    } 
    if (layer == AlojFamNaoClasPercCon91 && naoDuplicar != 73){
        legendaGradiente('Percentagem de Alojamentos Familiares Não Clássicos em 1991');
        slideAlojFamNaoClasPercCon91();
        naoDuplicar = 73;
    } 
    if (layer == AlojColePercCon21 && naoDuplicar != 39){
        legendaGradiente('Percentagem de Alojamentos Coletivos em 2021');
        slideAlojColePercCon21();
        naoDuplicar = 39;
    }
    if (layer == AlojColePercCon11 && naoDuplicar != 40){
        legendaGradiente('Percentagem de Alojamentos Coletivos em 2011');
        slideAlojColePercCon11();
        naoDuplicar = 40;
    }   
    if (layer == AlojColePercCon01 && naoDuplicar != 70){
        legendaGradiente('Percentagem de Alojamentos Coletivos em 2001');
        slideAlojColePercCon01();
        naoDuplicar = 70;
    }
    if (layer == AlojColePercCon91 && naoDuplicar != 74){
        legendaGradiente('Percentagem de Alojamentos Coletivos em 1991');
...
$('#absoluto').click(function(){
    ...
    reporAnos();
    primeirovalor('Total');
    $('#tituloMapa').html('<strong>' + 'Alojamentos por Tipo, N.º' + '</strong>');
});
...
$('#percentagem').click(function(){
    ...
    primeirovalor('AF');
    tamanhoOutros();
    $('#tituloMapa').html('<strong>' + 'Alojamentos por Tipo, %.' + '</strong>')
});
...
let notaRodapeNaoClass = function(texto){
    $('#notaRodape').html('Devido aos valores mais reduzidos, optou-se por aumentar a proporção dos círculos, de forma que seja possível uma melhor perceção, apenas sendo possível comparar com os <strong>' + texto + '</strong>.');
}
